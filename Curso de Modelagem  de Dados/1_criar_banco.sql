...
MODIFY COLUMN NOTA FLOTA(4,2);


-- Provavelmente, o trabalho em um BD nunca termina. Mesmo após finalizado, ainda podem ocorrer problemas não planejados anteriormente
-- assim como podem ser necessárias atualizações